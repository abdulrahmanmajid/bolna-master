...
DATE_PROMPT = '''### Current Date and Time: {} at {} local time in the {} timezone, located in the ({}) country. Use this information to ensure all time-related responses are accurate and contextually relevant. Note: This date, time, timezone, and country reflect your system's settings and may not necessarily correspond to the user's location.'''
